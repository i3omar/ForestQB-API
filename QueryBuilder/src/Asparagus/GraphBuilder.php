...
class GraphBuilder {
	...
	public function where( $subject, $predicate, $object ) {
		...
		$this->expressionValidator->validate( $object,
			ExpressionValidator::VALIDATE_VARIABLE | ExpressionValidator::VALIDATE_PREFIXED_IRI | ExpressionValidator::VALIDATE_NATIVE | ExpressionValidator::VALIDATE_COMPLEX_EXPRESSION | ExpressionValidator::VALIDATE_POLYGON
		);
	...
	public function filter( $expression ) {
		$this->expressionValidator->validate( $expression, ExpressionValidator::VALIDATE_FUNCTION | ExpressionValidator::VALIDATE_COMPARISON | ExpressionValidator::VALIDATE_NESTED_COMPARISON );
